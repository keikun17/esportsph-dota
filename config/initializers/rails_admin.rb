# RailsAdmin config file. Generated on July 10, 2013 11:51
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Esportsph Dota', 'Admin']
  ...
  # config.excluded_models = ['Hero', 'HeroSelection', 'Match', 'Player', 'PlayerMatch', 'Team', 'TeamMatch']

  # Include specific models (exclude the others):
  # config.included_models = ['Hero', 'HeroSelection', 'Match', 'Player', 'PlayerMatch', 'Team', 'TeamMatch']
  ...
  # config.model 'Hero' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your hero.rb model definition
  ...
  # config.model 'HeroSelection' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your hero_selection.rb model definition
  ...
  #     configure :winner, :belongs_to_association 
  #     configure :team_matches, :has_many_association 
  ...
  #     configure :hero_selection, :has_one_association 
  ...
  # config.model 'TeamMatch' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your team_match.rb model definition
